    ...
    products: [
      {
        ...
        gallery: [
          ...
          new URL(
            '@/assets/img/products/-zip-hoodie-plug/2.png',
            import.meta.url
          ).href,
          new URL(
            '@/assets/img/products/-zip-hoodie-plug/3.png',
            import.meta.url
          ).href,
          new URL(
            '@/assets/img/products/-zip-hoodie-plug/4.png',
            import.meta.url
          ).href,
          new URL(
            '@/assets/img/products/-zip-hoodie-plug/5.png',
            import.meta.url
          ).href
        ],
        sizes: [
      ...
      },
      {
        ...
        gallery: [
          ...
          new URL(
            '@/assets/img/products/sweatshirt-plug/2.png',
            import.meta.url
          ).href,
          new URL(
            '@/assets/img/products/sweatshirt-plug/3.png',
            import.meta.url
          ).href,
          new URL(
            '@/assets/img/products/sweatshirt-plug/4.png',
            import.meta.url
          ).href
        ],
        sizes: [
