...
const props = withDefaults(defineProps<Props>(), {
  ...
  pickpointAddress: undefined,
  changePickpointAddress: () => {}
})
  ...
  <div class="bg-[#e8e8e9] p-20 lg:p-30 2xl:p-40">
    <form @submit.prevent>
      ...
      <div class="">
        ...
        <p class="mb-10 !leading-none text-[#848a99] text-medium-16">Address</p>
        <div class="mb-10 flex items-center justify-between">
          <p
            class="text-[12px] font-semibold leading-none text-black lg:text-[14px]"
            :class="{ '!text-[#d84949]': !props.currentAddress }"
          >
            ...
            <template v-else>Choose delivery address</template>
          </p>
          <button @click="props.changeCurrentAddress" type="button">
            <svg
        ...
        <div class="flex flex-col gap-y-20 pt-25">
          ...
          <div v-if="deliveryModel[0] === true">
            <p class="mb-10 !leading-none text-[#848a99] text-medium-15">
              Pickpoint address:
            </p>
            <div class="mb-10 flex items-center justify-between">
              <p
                class="text-[12px] font-semibold leading-none text-black lg:text-[14px]"
                :class="{ '!text-[#d84949]': !props.pickpointAddress }"
              >
                {{ props.pickpointAddress || 'Choose pickpoint address' }}
              </p>
              <button @click="props.changePickpointAddress" type="button">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
        ...
        <div class="mt-20 md:mt-[50px]">
          ...
          <AppButton
            :disabled="
              ...
              !isSuccess ||
              isCartEmpty ||
              (deliveryModel[0] === true && !pickpointAddress)
            "
            fluid
            class="mb-25 h-65"
            @click="onCreateOrder"
