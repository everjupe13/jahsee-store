...
useHead({
  title: constructPageTitle('Confident')
})
      ...
      <div class="pt-30 md:pt-40">
        <div class="mb-35">
          ...
          <p class="mb-10">
            ...
            No152-ФЗ «О персональных данных» и определяет порядок обработки
            персональных данных и меры по обеспечению безопасности персональных
            данных, предпринимаемые гражданином Микериным Игорем Николаевичем
            зарегистрированным в качестве налогоплательщика на профессиональный
            доход (самозанятым), ИНН 741204653773
          </p>
          <p class="mb-10">
        ...
        <div class="mb-35">
          ...
          <p class="mb-10">
            ...
            доступность в сети интернет по сетевому адресу https://ayaysee.com/.
          </p>
          <p class="mb-10">
          ...
          <p class="mb-10">
            2.9. Пользователь – любой посетитель веб-сайта https://ayaysee.com/;
          </p>
          <p class="mb-10">
        ...
        <div class="mb-35">
          ...
          <p class="mb-10">3.1. Фамилия, имя, отчество;</p>
          <p class="mb-10">3.2. Электронный адрес;</p>
          <p class="mb-10">3.3. Номера телефонов;</p>
          <p class="mb-10">
            3.4. Адрес фактического места проживания или по месту пребывания;
          </p>
          <p class="mb-10">
            3.5. Также на сайте происходит сбор и обработка обезличенных данных
            о посетителях (в т.ч. файлов «cookie») с помощью сервисов
            интернет-статистики (Яндекс Метрика и Гугл Аналитика и других).
          </p>
          <p class="mb-10">
            3.6. Вышеперечисленные данные далее по тексту Политики объединены
        ...
        <div class="mb-35">
          ...
          <p class="mb-10">
            ...
            осуществление отправки заказов Пользователю по месту проживания или
            по месту пребывания.
          </p>
          <p class="mb-10">
            ...
            электронной почты ayaysee.corp@outlook.com с пометкой «Отказ от
            уведомлений о новых продуктах и услугах и специальных предложениях».
          </p>
          <p class="mb-10">
            4.3. Обезличенные данные Пользователей, собранные с помощью сервисов
        ...
        <div class="mb-35">
          ...
          <p class="mb-10">
            ...
            https://ayaysee.com/. Заполняя соответствующие формы и/или отправляя
        ...
        <div class="mb-35">
          ...
          <p class="mb-10">
            ...
            Оператора ayaysee.corp@outlook.com с пометкой «Актуализация
            персональных данных».
          </p>
          <p class="mb-10">
            ...
            ayaysee.corp@outlook.com с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
        </div>
        <div class="mb-35">
        ...
        <div class="mb-35">
          ...
          <p class="mb-10">
            ...
            к Оператору с помощью электронной почты ayaysee.corp@outlook.com.
          </p>
          <p class="mb-10">
          ...
          <p class="mb-10">
            ...
            сети Интернет по адресу https://ayaysee.com/confident.
          </p>
          <p class="mb-10">
            Электронная почта для связи: ayaysee.corp@outlook.com
          </p>
        </div>
      </div>
    </div>
